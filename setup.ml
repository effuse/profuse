...
(* OASIS_START *)
(* DO NOT EDIT (digest: e4399e84374142f9b679c176d03ca7a5) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("unix-errno", None);
                           FindlibPackage ("unix-sys-stat", None);
                           FindlibPackage ("unix-dirent", None);
                           FindlibPackage ("unix-unistd", None);
                           FindlibPackage ("unix-fcntl", None);
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "linux";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "profuse"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["Profuse"; "Lofs"; "Proxfuse"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "profuse";
                      lib_findlib_name = Some "linux";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "lib/cli";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "linux"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["Fuse_cli"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "profuse";
                      lib_findlib_name = Some "cli";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "linux";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "cli"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = true; exec_main_is = "lofs_main.ml"});
               Executable
                 ({
                     cs_name = "proxfuse_client";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "proxfuse_client.ml"});
               Executable
                 ({
                     cs_name = "proxlofs_server";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "proxlofs_server.ml"});
               Test
                 ({
                     cs_name = "linux_7_8";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_working_directory = Some "linux_test";
                      test_run =
                        [
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\233\023\0113Fu\161\005\222\160\194\000\219a\206H";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
